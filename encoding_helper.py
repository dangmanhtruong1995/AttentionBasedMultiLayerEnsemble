...
class LayerEncodingWrapper:
    ...
    def __init__(self, enc_in, n_clfs_prev, n_clfs):
        """ Parameters
        ----------
        enc_in : Encoding, of size (n_clfs*(n_clfs_prev+1)), flattened from an array of size (n_clfs, (n_clfs_prev+1)).
    ...
    def print_info(self):
        ...
        enc = self.enc
        print('    ------------------------')
        print('    Encoding information (first number for each classifier denotes whether it uses the original data or nor):')
